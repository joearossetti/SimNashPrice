...
my_struct_error_mat <- matrix(rnorm(num_prods*my_draws, 0, 1), my_draws, num_prods)
...
beta_is <- cbind(rnorm(50, 0, 1), rnorm(50, 0, 1), rnorm(50, 0, 1), rnorm(50, 0, 1), rnorm(50, 0, 1))
